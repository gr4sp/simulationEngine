...
from gr4spModelJT import getModelAfterBaseYear
...
if __name__ == '__main__':
    ...
    with MultiprocessingEvaluator(model, n_processes=79) as evaluator:
        ...
        results = evaluator.perform_experiments(scenarios=6, policies=0, uncertainty_sampling='uncertainties.ffJT.object')#, uncertainty_sampling='uncertainties.ff.object' , generate_experiments_file_only=True)
    ...
    save_results(results, r'./simulationData/gr4sp_JT' + datekey + '.tar.gz')
