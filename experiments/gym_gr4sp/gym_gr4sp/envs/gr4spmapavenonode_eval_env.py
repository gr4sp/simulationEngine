...
class Gr4spMapAveNoNodeEvalEnv(gym.Env):

    def __init__(self):

        self.action_space = spaces.Discrete(MAX_ACTIONS)
        self.wrapped = gym.make("gr4sp-v6")
        ...
        file = "90th_ea_checkpoint62_results"

        df = pd.read_csv(f"optimisers/{file}.csv")
    ...
    def update_avail_actions(self):
        ...
        self.action_mask = np.array([1 for i in range(MAX_ACTIONS)])
