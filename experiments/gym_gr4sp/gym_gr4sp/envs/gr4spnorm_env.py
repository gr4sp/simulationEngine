...
class Gr4spNormEnv(gym.Env):
    #   metadata = {'render.modes': ['human']}

    def __init__(self):
        super(Gr4spNormEnv, self).__init__()
        # print("Norm")
        ...
        self.max_vals = np.array([10.0, 1.0, 150.0, 300.0, 365.0])
    ...
    def reward_function(self):
        if self.curr_year != 2050:
            ...
            rewards = np.array(self.gr4spObj.getFinalAveInds())

            return np.sum((rewards * self.weights) / self.max_vals)
