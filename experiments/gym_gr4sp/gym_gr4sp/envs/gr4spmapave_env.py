...
class Gr4spMapAveEnv(gym.Env):

    def __init__(self):

        self.action_space = spaces.Discrete(MAX_ACTIONS)
        self.wrapped = gym.make("gr4sp-v4")
        ...
        folder = "RobustCompTipConverged"
        file = "90th_ea_checkpoint62_results"

        df = pd.read_csv(f"/home/ray/gr4sp/experiments/optimisers/{file}.csv")
