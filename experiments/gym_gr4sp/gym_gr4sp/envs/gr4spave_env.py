...
class Gr4spAveEnv(gym.Env):
    #   metadata = {'render.modes': ['human']}

    def __init__(self):
        super(Gr4spAveEnv, self).__init__()
        # print("Norm")
        ...
        self.scenarios_designs = list(self.df.to_records(index=False))[:100]
    ...
    def step(self, action):
        #print(os.getpid(), self.curr_year, action)
