...
# set levers
    ...
    model.uncertainties += [CategoricalParameter('onsiteGeneration', ['Central', 'Slow change', 'Fast change', 'Step change', 'High DER'])]
...
# variation of min and max capacity factors as a percentage of current values
    model.uncertainties += [IntegerParameter('capacityFactorChangeBattery', -10, 11)]
    ...
    model.uncertainties += [IntegerParameter('capacityFactorChangeCcgt', -10, 11)]
    model.uncertainties += [IntegerParameter('capacityFactorChangeWind', -10, 11)]
