...
from gr4spModelPathway import getModelTipTiming
import os
import sys
import pandas as pd
import pickle
...
if __name__ == '__main__':
    ...
    '''
    model = getModelTipTiming()
    #model = getModelTipAFterBaseYear()
    ...
    # percentile75 = functools.partial(np.percentile, q=75)

    MAXIMIZE = ScalarOutcome.MAXIMIZE
    MINIMIZE = ScalarOutcome.MINIMIZE
    robustnes_functions = [ScalarOutcome('90th percentile ghg', kind=MINIMIZE,
                                         variable_name='ghg', function=percentile90),
                           ScalarOutcome('10th percentile renew', kind=MAXIMIZE,
                                         variable_name='renew', function=percentile10),
                           ScalarOutcome('90th percentile tariff', kind=MINIMIZE,
                                         variable_name='tariff', function=percentile90),
                           ScalarOutcome('90th percentile wholsesale', kind=MINIMIZE,
                                         variable_name='wholsesale', function=percentile90),
                           ScalarOutcome('90th percentile unmet', kind=MINIMIZE,
                                         variable_name='unmet', function=percentile90)]
