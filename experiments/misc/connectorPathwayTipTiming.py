    ...
    while True:
        try:
            ...
            if os.path.isfile(csvFileName) is False or True:
                ...
                tipping_pathway = list(gr4spObj.policyManager.pastActions)
            ...
            if count > 10:
                ...
                return np.float64(5.645205538353292), np.float64(0.27847617061830227), \
                    ...
                    73.76962489152105), np.float64(54.735849056603776), [a0, a1, a2, a3, a4, a5, a6, a6]  # Intentional a6 twice
            # print(count)
            continue
        ...
        return ghg, renew, tariff, wholsesale, unmet, tipping_pathway
